...
CREATE TABLE `category_page` (
  ...
  KEY `category_page_page_id_index` (`page_id`),
  CONSTRAINT `category_page_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `page__categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `category_page_page_id_foreign` FOREIGN KEY (`page_id`) REFERENCES `page__pages` (`id`) ON DELETE CASCADE
